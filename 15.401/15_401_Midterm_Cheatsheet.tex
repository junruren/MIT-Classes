...
\Blue{Gordon growth model} a special case of DDM where dividends grow at a constant rate $g$.
\fbox{$P_0 = \frac{D_0 \cdot (1+g)}{r-g} = \frac{D_1}{r-g}$}
...
\begin{itemize}
    \item \Blue{Earnings Per Share (EPS)} net profit after taxes
    ...
    \item \Blue{Return on Equity (ROE)} \fbox{$\frac{\text{Net Income}}{\text{BV}}$}
